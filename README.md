...
---|---|---|---|---
 ...
 8 | [到最近的人的最大距离](https://leetcode.com/problems/max-consecutive-ones/) | 简单 | [JavaScript](https://github.com/StrangeClow/leetcode_JS/blob/master/leetcode/maxConsecutiveOnes.js) |  √
 ...
 30 | [最长回文串](https://leetcode-cn.com/problems/longest-palindrome/) | 中等 | [JavaScript](https://github.com/StrangeClow/leetcode_JS/blob/master/leetcode/longestPalindrome.js) |  ✘
 ...
 61 | [旋转数组的最小数字](https://leetcode-cn.com/problems/xuan-zhuan-shu-zu-de-zui-xiao-shu-zi-lcof/) | 简单 | [JavaScript](https://github.com/StrangeClow/leetcode_JS/blob/master/leetcode/rotateMinArray.js) |   √
 62 | [数组中出现次数超过一半的数字](https://leetcode-cn.com/problems/shu-zu-zhong-chu-xian-ci-shu-chao-guo-yi-ban-de-shu-zi-lcof/) | 简单 | [JavaScript](https://github.com/StrangeClow/leetcode_JS/blob/master/leetcode/majorityElement.js) |   √
...
---|---|---|---|---
 ...
 9 | [随机洗牌算法]() | H | [JavaScript](https://github.com/StrangeClow/leetcode_JS/blob/master/sort_in_JS/shuffle.js) |  √
...
> sort In Javascript end
 ...
 ###  algorithmThought :blush:==:blush:
     ...
     1. 分治算法
          复杂问题拆分相似子问题，指导最后可以简单的直接求解
          适用场景
            A.
         
     2. 动态规划算法
          每次决策依赖当前状态，又随即引起状态的转移

     3. 贪心算法 (当前看来最优解)
         每次求取当来看来是最优的解，局部最优解

     4. 回溯算法 
        类似枚举的过程，当发现当前不合适时，随即返回，寻找最新的解决办法
